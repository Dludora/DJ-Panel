...
These endpoints are the product-facing submission API.

### 12.3 Transitional Compatibility

The UI and product language should treat these records as processing submissions rather than generic run rows.
